...
def generate_random_color():
    global rgb_idx  # Add this line to modify the global variable
    rgb_idx += 1
    rgb_idx = rgb_idx % len(rgb_cluster)
    return rgb_cluster[rgb_idx][0], rgb_cluster[rgb_idx][1], rgb_cluster[rgb_idx][2]
...
for file_name, cluster in cluster_data.items():
    ...
    rgb_idx = (rgb_idx + 1) % len(rgb_cluster)  # Ensure rgb_idx is within bounds
